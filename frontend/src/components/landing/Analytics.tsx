  ...
  return (
    <Section id="analisis" className="py-32">
      ...
      <div className="mt-16 grid gap-8 lg:grid-cols-2">
        <Reveal>
          <div className="relative rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-md">
            ...
            <div className="mb-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-white">Lucas Moreira · Delantero</p>
                </div>
              </div>
          ...
          <div className="relative rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-md">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-white">Rendimiento agregado</p>
              </div>
            </div>
