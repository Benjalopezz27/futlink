      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {[
          ...
          <Reveal key={f.title} delay={i * 0.1}>
            <div className="group relative h-full rounded-2xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-md transition hover:border-emerald-400/40 hover:bg-white/[0.06]">
