    ...
    <footer className="relative border-t border-white/10 bg-slate-950">
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
          <Logo />
          <nav className="flex flex-wrap gap-x-8 gap-y-3 font-mono text-xs uppercase tracking-widest text-slate-400">
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-2 border-t border-white/10 pt-6 font-mono text-xs uppercase tracking-widest text-slate-500 md:flex-row">
