      ...
      <div className="pointer-events-none absolute inset-0 hidden lg:block z-10 select-none">
        ...
        <FloatingCard className="left-[1%] xl:left-[2%] top-[25%] w-64 text-left backdrop-blur-xl opacity-75 hover:opacity-100 hover:z-30 transition-all duration-300 border-white/10" delay={0}>
          ...
          <div className="mt-3 grid grid-cols-3 gap-2 text-center font-mono">
            <div className="rounded-md bg-slate-100 dark:bg-white/5 py-1.5 border border-slate-200/85 dark:border-transparent">
              <p className="text-[9px] uppercase text-slate-500 dark:text-slate-400">SPD</p>
              <p className="text-xs font-bold text-emerald-600 dark:text-emerald-300">32.1</p>
            </div>
            <div className="rounded-md bg-slate-100 dark:bg-white/5 py-1.5 border border-slate-200/85 dark:border-transparent">
              <p className="text-[9px] uppercase text-slate-500 dark:text-slate-400">GOL</p>
              <p className="text-xs font-bold text-emerald-600 dark:text-emerald-300">24</p>
            </div>
            <div className="rounded-md bg-slate-100 dark:bg-white/5 py-1.5 border border-slate-200/85 dark:border-transparent">
              <p className="text-[9px] uppercase text-slate-500 dark:text-slate-400">AST</p>
              <p className="text-xs font-bold text-emerald-600 dark:text-emerald-300">11</p>
            </div>
          </div>
        </FloatingCard>
