    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[92vh] max-w-7xl flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <div className="pointer-events-none absolute inset-0 hidden lg:block">
          <FloatingCard className="left-[4%] top-[22%] w-64 text-left" delay={0}>
          ...
          <FloatingCard className="right-[5%] top-[28%] w-56 text-left" delay={1.5}>
          ...
          <FloatingCard className="right-[10%] bottom-[10%] w-60 text-left" delay={0.8}>
